...
const features = [
  {
    ...
    description: 'GPT-4o powered chatbot that engages visitors naturally and extracts key information without feeling like a form.',
  ...
  },
  {
    ...
    description: 'Every conversation is scored in real-time. Hot leads get immediate notifications so you never miss a hot prospect.',
  ...
  },
  {
    ...
    description: 'Track leads over time, see conversion rates, and analyze your pipeline with beautiful charts.',
...
const techStack = [
  ...
  'GPT-4o', 'Supabase', 'Recharts', 'Vercel',
];

const scores = [
  { label: '🔥 Hot', range: '70-100', desc: 'High budget + clear need + contact info', color: 'text-red-500 bg-red-500/10' },
  { label: '⚡ Warm', range: '40-69', desc: 'Some qualification but missing key info', color: 'text-orange-500 bg-orange-500/10' },
  { label: '❄️ Cold', range: '10-39', desc: 'Low budget or minimal engagement', color: 'text-blue-500 bg-blue-500/10' },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border/50 bg-background/80 backdrop-blur-sm sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-xs ml-1 hidden sm:flex">AI-Powered</Badge>
          </div>
          <div className="flex items-center gap-2">
            <Link href="/dashboard">
      ...
      <section className="relative pt-20 pb-16 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <Badge className="mb-4 bg-indigo-600/10 text-indigo-600 border-indigo-200 dark:border-indigo-800">
            <Sparkles className="w-3 h-3 mr-1" />
            AI Lead Qualification
          </Badge>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-gradient-to-br from-foreground to-foreground/60 bg-clip-text text-transparent">
            Qualify leads while
            <br />
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
            An embeddable AI chatbot that naturally converses with your visitors,
            qualifies them automatically, and sends instant alerts for hot leads.
            Built with GPT-4o for next-level conversations.
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">Everything you need to qualify leads</h2>
            <p className="text-muted-foreground">From first contact to qualified prospect in minutes</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map(({ icon: Icon, title, description, color, bg }) => (
              <Card key={title} className="border-border/50 hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors">
      ...
      <section className="py-16 px-4 bg-muted/20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">Every lead gets a score based on configurable criteria</p>
          </div>
